<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="PackageDetail.aspx.cs" Inherits="Admin_PackageDetail" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:TextBox ID="package_idss" ClientIDMode="Static" Style="display:none;" runat="server" />
    <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
    <div class="col-md-12" style="background-color: #464646; padding-right: 0; padding-top: 8px;">
        <div class="col-md-2" style="padding: 0;">
            <div class="col-md-2">
                <div class="row">
                    <asp:HyperLink ID="package_basic_info" onclick="$('.page_frame').css('display', 'block'); $('#content_item').css('display', 'none');" Target="Page_Preview" runat="server" CssClass="btn btn-primary BasicInfo">
            ...
            <div class="col-md-10">
                <h3 style="margin-top: 3px;">
                    <asp:Label ID="package_name" Style="color: white;" runat="server">HyperLink</asp:Label>

                    <%--<asp:LinkButton ID="" OnClick="package_name_Click" runat="server"></asp:LinkButton>--%></h3>
            </div>
        </div>
       <%-- <div class="col-md-2">
            <div class="dropdown">
                <a id="dLabel" data-target="#" href="#" class="btn btn-default" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><span id="dLabelSpan">Select package Pages</span>
    <span class="caret"></span>
                </a>

                <div class="dropdown-menu" style="width: 600px; height: 350px;" aria-labelledby="dLabel">
                    <div class="col-md-12">
                        <input type="text" class="form-control" placeholder="Filter package Pages" id="filter_pages" />
                    </div>
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-6">
                                <h4>Exquisite Pages</h4>
                                <asp:Repeater ID="package_pages" OnItemDataBound="package_pages_ItemDataBound" runat="server">
                                    <ItemTemplate>
                                        <div class="col-md-4">
                                            <h5>
    ...
    <%--<div class="col-md-2" style="padding: 0; background-color: #464646; height: 570px; overflow-y: auto;">
        <div id="accordion" role="tablist" aria-multiselectable="true">
            ...
            <div class="col-md-6">
                <div class="row">
                    <a class="btn btn-primary" role="button" style="width: 100%;" data-parent="#accordion" data-toggle="collapse" data-target="#search_package_pages" aria-expanded="false" aria-controls="search_package_pages">
            ...
            <div class="collapse" id="search_package_pages">
                <div class="well" style="height: 70px;">
                    <div class="col-md-12" style="padding: 0">
            ...
            <uc1:packagePageListView runat="server" ID="packagePageListView" OnpackagePageClicked="packagePageClicked" />
        </div>
    </div>--%>
