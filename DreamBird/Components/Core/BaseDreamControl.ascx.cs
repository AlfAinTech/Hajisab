...
public partial class Components_Core_BaseDreamControl : System.Web.UI.UserControl,IBaseDreamControl
{
...
"System.Drawing.Design.UITypeEditor, System.Drawing")]
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
       ...
       //     hideAllLinkButton();
        ...
        defaultControlInstance = LoadControlObject(DefaultControl);
                 ICoreDreamControl Idefault = (ICoreDreamControl)defaultControlInstance;
                 phDefaultArea.Controls.Add(defaultControlInstance);
                 Idefault.SetBaseDreamControl(this);
 ...
 // enclose admin security enclose end.
    ...
    private Control LoadControlObject(string path) {
        ...
        ICoreDreamControl coreDreamControl= (ICoreDreamControl)control;
        coreDreamControl.BindData();
        return control;
    }
    ...
    public string getBaseDreamClientID()
    {
    ...
    public string getBaseDreamServerID()
    {
        return this.ID;
    }

    public string GetDefaultDreamControlName()
    {
