<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RecentDreams.ascx.cs" Inherits="Components_Dreams_RecentDreams" %>
<link rel="stylesheet" href="https://fonts.googleapis.com/icon?family=Material+Icons">

<div class="row"><div class="col-md-12">
				<h3 style="color: #eb8c2e;">Recent Dreams</h3>
...
<ContentTemplate>
    <asp:Repeater ID="related_dreams" runat="server">
          <ItemTemplate>
				<div class="col-md-6">
					<div class="content_item container_featured" style="min-height:108px;">
                        
						<div class="col-md-3" style="padding:0;"><div>
                             <asp:Image ID="dream_img" runat="server" ImageUrl='<%# Eval("MediaItem.Path100") %>' Visible='<%# Bind("IsMediaItemImage") %>'  />
                                <br />
						...
						<div class="col-md-5" style="padding:0;">
							<div class="content_pan" style="min-height: auto; max-height: auto;">
                                <h4 style="margin-top:5px;">  <asp:Label ID="dreamName" runat="server" Height="16px" Text='<%# Eval("DreamName") %>' Visible="true" Width="100%" Font-Bold="true" Enabled="False"></asp:Label></h4>
