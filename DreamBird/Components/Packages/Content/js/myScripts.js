jQuery(document).ready(function ($) {
    ...
    $(document).on('click', '#search_dream', function (e) {
        ...
        $.ajax({
            url: "../../Components/Packages/Content/SearchHandler.ashx?SearchKeyword=" + SearchKeyword,
            type: 'POST',
    ...
    $(document).on('click', '#like_now', function (e) {
        ...
        $.ajax({
            url: "../../Components/Packages/Content/GridPopulator.ashx?Status=" + LikeStatus + "&&Counter=0&&Mode=Like&&DID=" + DreamID,
            type: 'POST',
            success: function (result) {
...
function render_grid() {
    ...
    $.ajax({
        url: "../../Components/Packages/Content/GridPopulator.ashx?Mode=Render&&Counter=" + counter,
        type: 'POST',
        success: function (result) {
