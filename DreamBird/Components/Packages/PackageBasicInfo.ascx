<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PackageBasicInfo.ascx.cs" Inherits="Components_Package_PackageBasicInfo" %>
...
<%--<%@ Register Src="~/Components/Packages/DreamDetail.ascx" TagPrefix="uc1" TagName="DreamDetail" %>--%>
    ...
    <div class="col-md-12" style="background-color: #e6e6e6; padding-top: 25px;">
        <div class="col-md-8">
            <div class="col-md-12" style="padding: 0">
                <div class="col-md-12">
                    <h5>Package Name</h5>
                    <asp:TextBox ID="PackageName_txt" runat="server" CssClass="form-control" placeholder="Package Name"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="namevalidator" runat="server" ControlToValidate="PackageName_txt" ErrorMessage="Add Name" ForeColor="Red"></asp:RequiredFieldValidator>
                </div>
             <%--   <div class="col-md-6">
                    <h5>Package Tags</h5>
            ...
            <div class="col-md-12" style="padding: 0">
               ...
               <%-- <div class="col-md-6">
                    <h5>Package Type</h5>
                    <asp:DropDownList ID="PackageType_list" runat="server" CssClass="form-control" DataTextField="Name" DataValueField="id"></asp:DropDownList>
                </div>--%>
            </div>
            <div class="col-md-12">
                <h4>Description
                    ...
                    <ContentTemplate>
                        <asp:Repeater ID="Dream_pages_list" runat="server" OnItemDataBound="Dream_pages_list_ItemDataBound">
                            ...
                            <ItemTemplate>
                                <tr>
                                    <td>
                                        <asp:LinkButton ID="PageName" runat="server" Text='<%# Eval("Page") %>' data-toggle="modal" data-pageName='<%# Eval("Page") %>' data-dreamID='<%# Eval("DreamID") %>' data-PackageName='<%# Eval("Dream.PackageName") %>' data-target="#pageTemplate"></asp:LinkButton><asp:Label ID="id" runat="server" Text='<%# Eval("id") %>' Visible="false"></asp:Label></td>
                                    <td>
