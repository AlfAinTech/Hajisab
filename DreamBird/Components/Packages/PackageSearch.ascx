<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PackageSearch.ascx.cs" Inherits="Components_Package_PackageSearch" %>
...
<div class="col-md-10" style="padding: 15px; background-color: #404040; display: inline-block;">
    ...
    <div class="col-md-4" style="padding: 0;">
        <asp:Button ID="search_dream" runat="server" OnClick="search_dream_Click" Text="Search" Style="width: 100%;" class="btn btn-default" CausesValidation="false" />
