<%@ WebHandler Language="C#" Class="FillInBlanksHandler" %>
...
public class FillInBlanksHandler : IHttpHandler
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        if (purpose.Equals("AddNewFIBQuestion"))
        {
        ...
        else if (purpose.Equals("editFIBQuestionText") && qid != null)
        {
