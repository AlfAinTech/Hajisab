...
<asp:Panel ID="search_panel" runat="server">
    ...
    <div class="col-md-2" style="padding:15px 15px 15px 0; background-color:#404040; display:inline-block;"><asp:LinkButton ID="add_btn" CssClass="btn btn-default" runat="server" CausesValidation="false" OnClick="add_btn_Click" Text="+" ></asp:LinkButton>
    </div>
</asp:Panel>
<div class="col-md-12">
<asp:Repeater ID="AirLine_data_list" runat="server">
    <HeaderTemplate>
        <div class="list-gro up">
    </HeaderTemplate>
    <ItemTemplate>
