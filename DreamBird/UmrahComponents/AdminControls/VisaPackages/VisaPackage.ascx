    ...
    <ItemTemplate>
        <tr>
                    <td>
                        ...
                        <div class="col-md-6" style="padding:0;">
                            <asp:LinkButton runat="server" ID="delete_btn" CommandArgument='<%# Eval("id") %>'  OnClientClick="return callModal(this);" OnClick="deleteButton_clicked" class="btn btn-primary"><span class="glyphicon glyphicon-remove"></span></asp:LinkButton>
                        </div>
                    </td>
                    <td>
