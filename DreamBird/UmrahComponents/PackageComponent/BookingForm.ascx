...
<div class="container search_result" style="background-color: white; box-shadow: 2px 2px 2px 2px #717171; margin-top: 50px; margin-bottom: 50px; min-height: 650px">
    <div class="bookingContainer" id="bookingContainer" runat="server" style="background-color: white;">
        <h2 style="text-align: center; font-family: 'Montserrat Bold', sans-serif; font-size: 2em;">Booking Information</h2>
        <div class="col-md-12" id="booking_form">
            <div class="col-md-6">

                <h4 style="font-weight: 800;">Customer Detail</h4>
                <div class="col-md-12">
                    <h5>Name</h5>
                    <asp:TextBox runat="server" ID="name_txt" class="form-control only-text" name="" type="text" />
                ...
                <div class="col-md-12">
                    <h5>Mobile Number</h5>
                    <asp:TextBox runat="server" ID="mobile_txt" class="form-control numeric" name="" placeholder="03121231234" />
          ...
          <div class="col-md-6">
               <h5>Province</h5>
                ...
                <div class="col-md-12">
                    ...
                    <div class="row">
                        ...
                        <h4 style="font-weight: 800; text-align: left; padding-left: 15px;">Passengers</h4>
                        <div class="col-md-12">
                            <div class="col-md-4">
                                <h5>Adults</h5>
            ...
            <div class="col-md-6">
                ...
                <div class="col-md-10" style="margin-right: auto; margin-left: auto; float: none; box-shadow: 1px 1px 4px rgba(0,0,0,.4); padding: 15px;">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="col-md-8 detail_package_detail">
                                <h5>
                                    <asp:Label ID="hotelName_madina" runat="server"></asp:Label></h5>
                                <div class="col-md-12" style="padding: 0; font-size: .8em;" runat="server" id="Div1">
                                    <asp:Label ID="hotelRating_madina" runat="server" class="stars"></asp:Label>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="col-md-8 detail_package_detail">
                                <h5>
                                    <asp:Label ID="hotelName_makkah" runat="server"></asp:Label></h5>
                                <div class="col-md-12" style="padding: 0; font-size: .8em;" runat="server" id="star_div">
                                    <asp:Label ID="hotelRating_makkah" runat="server" class="stars"></asp:Label>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="col-md-8 detail_package_detail">
                                <h5>
                                    <asp:Label ID="totelNights" runat="server"></asp:Label></h5>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="col-md-8 detail_package_detail">
                                <h5>
                                    <asp:Label ID="nights_inMakkah" runat="server"></asp:Label>
                                    Nights</h5>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="col-md-8 detail_package_detail">
                                <h5>
                                    <asp:Label ID="nights_inMadina" runat="server"></asp:Label>
                                    Nights</h5>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-8 detail_package_detail">
                                <asp:Panel ID="oneWay_panel" runat="server" Visible="false">
                                    <h5>
                                        <asp:Label ID="departureAirLine_name" runat="server"></asp:Label>-<asp:Label ID="returnAirLine_name" runat="server"></asp:Label></h5>
                                </asp:Panel>

                                <asp:Panel ID="roundTrip_panel" runat="server" Visible="false">
                                    <h5>
                                        <asp:Label ID="AirLine_name" runat="server"></asp:Label></h5>
                                </asp:Panel>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12" style="margin-top: 20px;">
                            ...
                            <h2 style="text-align: center; font-weight: 800;">
                                <asp:Label ID="Computed_amount" runat="server"></asp:Label>
                                <span class="pkr">PKR</span>
                            </h2>
                        </div>
                    </div>
                </div>
                <div class="col-md-10" style="margin-right: auto; margin-left: auto; float: none; padding: 15px 0;padding-top:160px;">
                    <div class="row">
    ...
    <div id="FinalContainer" runat="server" class="finalContainer" style="background-color: white; margin: 10px; display: none">
        <div style="margin-left: auto; margin-right: auto; float: none; width: 58.33333333%;">
            <div style="border: solid #190940; padding: 20px; padding-left: 40px; padding-right: 40px;">
                <h2 style="text-align: center; color: #190940;">
                    <asp:Literal ID="txtfullnights" runat="server"></asp:Literal>
                    Days Umrah Package</h2>
                <div style="padding-left: 20px; padding-right: 20px; margin-left: -15px; margin-right: -15px;">
                    ...
                    <h3><span>Tracking ID :
                        <asp:Literal ID="txttrackingId" runat="server"></asp:Literal></span></h3>
                </div>
            </div>
