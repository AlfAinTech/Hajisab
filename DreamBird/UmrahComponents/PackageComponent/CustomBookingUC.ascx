<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CustomBookingUC.ascx.cs" Inherits="UmrahComponents_PackageComponent_CustomBookingUC" %>
          ...
          <div  style="margin-left:auto; margin-right:auto; float:none;width: 58.33333333%;">
                <div style="border:solid #190940;padding: 20px;padding-left: 40px;padding-right: 40px;">
                    ...
                    <div  style="padding-left:20px; padding-right:20px;margin-left: -15px;margin-right: -15px;">
                        ...
                        <p>Thank you for Booking Your Custom Umrah Package at <a href="http://www.hajisab.com">hajisab.com</a>. Our Agent will contact you soon. Your Package booked with given Tracking ID. </p>
