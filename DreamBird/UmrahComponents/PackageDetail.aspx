<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PackageDetail.aspx.cs" Inherits="UmrahComponents_PackageComponent_PackageDetail" %>
    ...
    <body>
        ...
        <div class="slider_wrapper_search">
                <div class="package_title_detail">
                    <h2>
                        <asp:Label ID="package_name" runat="server"></asp:Label></h2>
                </div>
            </div>
       <div class="content_wrapper">
    <div class="container"><div class="col-md-9">
        <uc1:PackagePageDetail runat="server" ID="PackagePageDetail" /></div>
        <div class="col-md-3"><uc1:PackagediscountDetail runat="server" ID="PackagediscountDetail"  isCustomPackage="false"/></div>
        </div></div>
