<%@ Control Language="C#" AutoEventWireup="true" CodeFile="HeaderUmrahNLPChat.ascx.cs" Inherits="UmrahComponents_headerFooter_HeaderUmrahNLPChat" %>
<%@ Register Src="~/chat/ChatControl.ascx" TagPrefix="uc1" TagName="ChatControl" %>
<%@ Register Src="~/chat/NLPChatUC.ascx" TagPrefix="uc1" TagName="NLPChatUC" %>
    ...
    <div id="slider_overlay">
        ...
        <div id="right">
            ...
            <div id="second">
                ...
                <uc1:NLPChatUC runat="server" ID="NLPChatUC" />
            </div>
        </div>
    </div>
    </div>